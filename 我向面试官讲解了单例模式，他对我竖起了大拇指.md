...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVThG6fpzw3RK3y6ic8JN349SXRrbvIiaibEByqG9wKYbibTppKh8P9MicW1KQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTJpl55yVgTZtia8gRX8ACgxKIvZR4DmA1QYqNJJvkBnP3KutK1MbD6rg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTYw7j0YiaUdbRvdWbej5xd7BeMLaT8GhEx8qn5wjwsWZEqUxT57BB4zw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTMzM1H4wticib05wYgIjYWUZpPibTLD9dPUcyjy7ObSCQDEBxlAYbPQNSg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
这样就规避了两个线程同时创建Singleton对象的风险，但是引来另外一个问题：每次去获取对象都需要先获取锁，并发性能非常地差，极端情况下，可能会出现卡顿现象。接下来要做的就是`优化性能`：目标是如果没有实例化对象则加锁创建，如果已经实例化了，则不需要加锁，直接获取实例
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTPVOVXftDwsqCZZ9QpuRsj2a5DA6iaSKOGrN7dxy7DPE7pcdu0PnZKbg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTCicibnibGrVe3okYxhHy6RKrZgLfK4FPA7MweUJcvRyPEmB1yVIjZBEUg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTZSvzYFUxxFqbiarXVqNH0oXOWuO91Swdr39w0FKaqk1cjMVvOnibunWw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdU657hFy0jqHsD1QjZrPgVTuRgd5iajPTpr5gbuIoY4BiaiaCPvedjic0giayCKbwGvShFlx5JqW17z1tA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
